...
namespace EmploymentAgency.ViewModels.Locators
{
    public class ViewModelLocator
    {
        ...
        public ChangeSupplementInformationForApplicantViewModel ChangeSupplementInformationForApplicantViewModel => _provider.GetRequiredService<ChangeSupplementInformationForApplicantViewModel>();

        public ChangeSupplementInformationForEmployerViewModel ChangeSupplementInformationForEmployerViewModel => _provider.GetRequiredService<ChangeSupplementInformationForEmployerViewModel>();
        ...
        public ChangeVacancyViewModel ChangeVacancyViewModel => _provider.GetRequiredService<ChangeVacancyViewModel>();

        public MyRequestsViewModel MyRequestsViewModel => _provider.GetRequiredService<MyRequestsViewModel>();

        public AddRequestViewModel AddRequestViewModel => _provider.GetRequiredService<AddRequestViewModel>();

        public ChangeRequestViewModel ChangeRequestViewModel => _provider.GetRequiredService<ChangeRequestViewModel>();

        public VacanciesViewModel VacanciesViewModel => _provider.GetRequiredService<VacanciesViewModel>();
        ...
        public DetailVacancyViewModel DetailVacancyViewModel => _provider.GetRequiredService<DetailVacancyViewModel>();

        public DetailRequestViewModel DetailRequestViewModel => _provider.GetRequiredService<DetailRequestViewModel>();

        public MyContractsApplicantViewModel MyContractsApplicantViewModel => _provider.GetRequiredService<MyContractsApplicantViewModel>();
        ...
        public static void Init()
        {
            ...
            services.AddTransient<ChangeVacancyViewModel>();
            ...
            services.AddTransient<DetailVacancyViewModel>();
