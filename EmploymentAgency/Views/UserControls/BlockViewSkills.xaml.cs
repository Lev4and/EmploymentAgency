...
{
    /// <summary>
    /// Логика взаимодействия для BlockViewSkills.xaml
    /// </summary>
    public partial class BlockViewSkills : UserControl
    {
        ...
        public static readonly DependencyProperty SelectedValuePathProperty =
            DependencyProperty.Register("SelectedValuePath", typeof(string), typeof(BlockViewSkills), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty SelectedValueProperty =
            DependencyProperty.Register("SelectedValue", typeof(object), typeof(BlockViewSkills), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty DataProperty =
            DependencyProperty.Register("Data", typeof(ObservableCollection<object>), typeof(BlockViewSkills), new PropertyMetadata(null, Data_Changed));

        private static void Data_Changed(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var current = d as BlockViewSkills;
        ...
        public List<BlockViewSkill> Items
        {
            get { return (List<BlockViewSkill>)GetValue(ItemsProperty); }
            set { SetValue(ItemsProperty, value); }
        }

        public static readonly DependencyProperty ItemsProperty =
            DependencyProperty.Register("Items", typeof(List<BlockViewSkill>), typeof(BlockViewSkills), new PropertyMetadata(null));

        public BlockViewSkills()
        {
            InitializeComponent();
        ...
        {
            var item = (sender as BlockViewSkill);

            SelectedValue = item.Skill.GetType().GetProperty(SelectedValuePath).GetValue(item.Skill);
        ...
        private void SelectItem(BlockViewSkill item)
        {
